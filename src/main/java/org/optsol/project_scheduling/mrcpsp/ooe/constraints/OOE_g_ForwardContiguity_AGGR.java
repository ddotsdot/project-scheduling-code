...
public class OOE_g_ForwardContiguity_AGGR<CONST
    extends IConstants_E & IConstants_A & IConstants_M_i>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public OOE_g_ForwardContiguity_AGGR() {
    super("i", "e");
  }
  ...
  protected void configureConstraint(
    ...
    // sum_m sum_e'=e..A-1 z_ime' + (A-e) * sum_m (z_im,e-1 - z_ime) <= A - e
    // sum_m sum_e'=e+1..A-1 z_ime' + sum_m z_ime + (A-e) * sum_m z_im,e-1 - (A-e) * sum_m z_ime <= A - e
    // sum_m sum_e'=e+1..A-1 z_ime' + sum_m z_ime + (A-e) * sum_m z_im,e-1 + (e-A) * sum_m z_ime <= A - e
    // sum_m sum_e'=e+1..A-1 z_ime'               + (A-e) * sum_m z_im,e-1 + (e-A+1) * sum_m z_ime <= A - e
