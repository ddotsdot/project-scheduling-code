...
public class OOE_TWb_CompletionTime_UB<CONST extends
  ...
  protected void configureConstraint(
    ...
    for (int m : constants.get_M_i(i)) {
      double coeff = -(constants.get_L_i(i) + constants.get_p_im(i, m)
          - constants.get_L_i(constants.get_A_bar()));
