...
public class CPM_Bwd_c_InitProjectStart<CONST extends IConstants_V & IConstants_MakespanUpperBound>
  ...
  protected void configureConstraint(
    ...
    constraint.setCoefficient(
        variables.getVar(DecisionVars_Cpm_Bwd.c, constants.get_dummy_activity_project_start()),
        1.);
  }
}
