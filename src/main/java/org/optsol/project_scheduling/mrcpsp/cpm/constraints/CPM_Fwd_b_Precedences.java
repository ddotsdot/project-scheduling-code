...
public class CPM_Fwd_b_Precedences<CONST extends IConstants_P & IConstants_p_im>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public CPM_Fwd_b_Precedences() {
    super("i", "j");
  }
  ...
  protected void configureConstraint(
    ...
    constraint.setLb(constants.get_p_i_min(i));

    constraint.setCoefficient(
        variables.getVar(DecisionVars_Cpm_Fwd.s, j),
        1.);

    constraint.setCoefficient(
        variables.getVar(DecisionVars_Cpm_Fwd.s, i),
        -1.);
  }
}
