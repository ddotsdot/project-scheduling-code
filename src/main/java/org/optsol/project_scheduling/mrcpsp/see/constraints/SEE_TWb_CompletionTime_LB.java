...
public class SEE_TWb_CompletionTime_LB<CONST
    extends IConstants_A & IConstants_E & IConstants_M_i & IConstants_E_i & IConstants_L_i & IConstants_p_im>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public SEE_TWb_CompletionTime_LB() {
    super("i", "e");
  }
    ...
    for (int m : constants.get_M_i(i)) {
      for (int ePrime = 1; ePrime <= e; ePrime++) {
        constraint.setCoefficient(
            variables.getVar(DecisionVars_See.y, i, m, ePrime),
            -(constants.get_E_i(i) + constants.get_p_im(i, m)));
      }
    }
  }
}
