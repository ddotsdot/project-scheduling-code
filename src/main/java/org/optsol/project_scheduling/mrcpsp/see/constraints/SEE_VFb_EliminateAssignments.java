...
public class SEE_VFb_EliminateAssignments<CONST extends IConstants_E & IConstants_A & IConstants_M_i & IConstants_G_bar>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public SEE_VFb_EliminateAssignments() {
    super("i", "m", "e");
  }
  ...
  protected void configureConstraint(
    ...
    MPVariable var = variables.getVar(DecisionVars_See.y, i, m, e);
    var.setLb(0.);
    var.setUb(0.);
  }
}
