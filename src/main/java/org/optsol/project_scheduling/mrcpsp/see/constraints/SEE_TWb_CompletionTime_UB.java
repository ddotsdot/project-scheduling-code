...
public class SEE_TWb_CompletionTime_UB<CONST
    extends IConstants_V & IConstants_E & IConstants_M_i & IConstants_p_im & IConstants_E_i & IConstants_L_i>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public SEE_TWb_CompletionTime_UB() {
    super("i", "e");
  }
  ...
  protected void configureConstraint(
    ...
    for (int m : constants.get_M_i(i)) {
      constraint.setCoefficient(
          ...
          -(constants.get_L_i(i) + constants.get_p_im(i, m) - L_A_bar));
    }
  }
}
