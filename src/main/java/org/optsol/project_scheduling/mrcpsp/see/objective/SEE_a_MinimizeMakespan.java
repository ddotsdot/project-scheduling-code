...
public class SEE_a_MinimizeMakespan extends AbstractOrtoolsObjectiveManager<ISeeModel_Constants> {
  ...
  protected void configureObjective(MPObjective objective,
    ...
    objective.setCoefficient(variables.getVar(DecisionVars_See.s, constants.get_card_A()), 1);
  }
}
