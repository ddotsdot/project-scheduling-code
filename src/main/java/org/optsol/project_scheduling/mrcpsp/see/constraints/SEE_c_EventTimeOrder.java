...
public class SEE_c_EventTimeOrder<CONST extends IConstants_A & IConstants_E>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public SEE_c_EventTimeOrder() {
    super("e");
  }
  ...
  protected void configureConstraint(
    ...
    constraint.setCoefficient(variables.getVar(DecisionVars_See.s, e + 1), -1);
  }
