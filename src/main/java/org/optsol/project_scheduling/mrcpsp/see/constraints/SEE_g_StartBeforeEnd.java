...
public class SEE_g_StartBeforeEnd<CONST extends IConstants_A & IConstants_E & IConstants_M_i>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public SEE_g_StartBeforeEnd() {
    super("i", "e");
  }
  ...
  protected void configureConstraint(
    ...
    for (int m : constants.get_M_i(i)) {
      for (int e2 = e; e2 < constants.get_card_A(); e2++) {
        constraint.setCoefficient(variables.getVar(DecisionVars_See.x, i, m, e2), 1);
      }
    }
  }
}