...
public class RSEE_f_ForceEnd<CONST extends IConstants_A & IConstants_E & IConstants_M_i>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public RSEE_f_ForceEnd() {
    super("i");
  }
  ...
  protected void configureConstraint(MPConstraint constraint, CONST constants,
    ...
    for (int m : constants.get_M_i(i)) {
      constraint.setCoefficient(
          variables.getVar(DecisionVars_Rsee.y_tilde, i, m, constants.get_card_A()),
          1);
    }
  }
}
