...
public class FCT_l_FixTransitivePrecedences<CONST extends IConstants_H_G>
    extends AbstractOrtoolsConstraintManager<CONST> {

  public FCT_l_FixTransitivePrecedences() {
    super("i", "j");
  }
  ...
  protected void configureConstraint(
    ...
    MPVariable var = variables.getVar(DecisionVars_Fct.y, j, i);
    var.setUb(0.);
    var.setLb(0.);
  }
}
